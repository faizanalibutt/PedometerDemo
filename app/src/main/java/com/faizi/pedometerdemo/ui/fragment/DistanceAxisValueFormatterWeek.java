...
public class DistanceAxisValueFormatterWeek extends ValueFormatter
{

    private final BarLineChartBase<?> chart;
    private List<DistanceTotal> listCurrentWeekInterval;

    public DistanceAxisValueFormatterWeek(BarLineChartBase<?> chart) {
        this.chart = chart;
    }

    public DistanceAxisValueFormatterWeek(@NotNull BarChart chart, @NotNull List<DistanceTotal> listCurrentWeekInterval) {
        this.chart = chart;
