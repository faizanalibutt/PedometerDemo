...
public class LocaleManagerX {
    ...
    public String getLanguage() {
        return prefs.getString(LANGUAGE_KEY, getDefaultLanguage());

    }

    private String getDefaultLanguage() {

        String finalCode = LANGUAGE_ENGLISH;
        for (String code : Utility.language_code) {
            if (code.equals(Locale.getDefault().getLanguage())) {
                finalCode = Locale.getDefault().getLanguage();
                break;
            }
        }
        return finalCode;
