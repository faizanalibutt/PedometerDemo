...
public class SpeedoRippleEffect extends RelativeLayout {
    ...
    public SpeedoRippleEffect(Context context) {
        super(context);
    }

    public SpeedoRippleEffect(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SpeedoRippleEffect(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void startAnimateRipple() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                float centreX = SpeedoRippleEffect.this.getX() + SpeedoRippleEffect.this.getWidth() /2;
                float centreY = SpeedoRippleEffect.this.getY() + SpeedoRippleEffect.this.getHeight()/2;
                createAnimation(centreX, centreY);
            }
        },0);
...
//    }
    ...
    public interface OnRippleCompleteListener {
        void onComplete(SpeedoRippleEffect rippleView);
    }
